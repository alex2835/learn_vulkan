...
ImGuiRenderPass::ImGuiRenderPass( const Device& device, const SwapChain& swap_chain )
	: RenderPass( device, swap_chain )
{}
...
void ImGuiRenderPass::createRenderPass()
{
	...
	attachmentDescription.format = m_swap_chain.imageFormat();
