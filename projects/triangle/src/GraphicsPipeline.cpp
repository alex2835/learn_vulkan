...
std::vector<char> vks::GraphicsPipeline::LoadShaderFromFile( const std::filesystem::path path )
{
...
//void GraphicsPipeline::createPipeline( const std::filesystem::path vert_path, const std::filesystem::path frag_path )
void GraphicsPipeline::createPipeline( )
{
	//auto vert_data = LoadShaderFromFile( vert_path );
	//auto frag_data = LoadShaderFromFile( frag_path );
	//VkShaderModule vertShaderModule = createShaderModule( vert_data );
	//VkShaderModule fragShaderModule = createShaderModule( frag_data );
